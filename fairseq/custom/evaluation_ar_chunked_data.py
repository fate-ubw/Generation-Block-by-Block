...
from fairseq.custom import evaluate_utils_chunk_ar
...
def main():
    ...
    for i, checkpoint in enumerate(checkpoints):
        if high_level_args.eval_mode in ['all', 'completion']:
            ...
            FAIRSEQ_OPTS = "--data {} \
                            --task language_modeling_with_generation_ar_chunk \
                            --path {} \
                            --tokens-per-sample {} \
                            --max-tokens {} \
            ...
            task, model, generator, itr, step = evaluate_utils_chunk_ar.load(args, re_init_weight=high_level_args.re_init_weight)
            # Note: the generator build in tesk file "language_modeling_with_generation_ar_chunk.py"
            ...
            completions, gt_completions, gen_metrics, actual_metrics = evaluate_utils_chunk_ar.generate_completions_ar(
