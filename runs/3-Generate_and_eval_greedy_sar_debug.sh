...
TASK=3-Chunk_sar_model_debug
SAVE_LOG_PATH=/mnt/nfs-storage/jim/DITTO_chunk/checkpoints/3-evaluation_logs_chunk_sar_greedy_debug
...
ls -l $SAVE_PATH
python  -u -i /mnt/nfs-storage/jim/DITTO_chunk/fairseq/custom/evaluation_sar_chunked_data.py \
